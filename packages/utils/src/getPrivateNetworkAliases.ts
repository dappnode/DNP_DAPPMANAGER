 ...
 * @returns
 */
export function getPrivateNetworkAliases(container: ContainerNames & { isMainOrMonoservice: boolean }): string[] {
  ...
  if (dnpName === params.dappmanagerDnpName) aliases.push(...params.DAPPMANAGER_ALIASES);
