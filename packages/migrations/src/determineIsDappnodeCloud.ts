...
/**
 * Determine weather or not is a dappnode cloud by fetching instance user data
 ...
 */
export async function determineIsDappnodeCloud(): Promise<void> {
  // skip of already migrated
  if (db.isDappnodeCloud.get() !== null) return;
