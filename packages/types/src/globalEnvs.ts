...
export const GLOBAL_ENVS = {
  ...
  STARKNET_EXECUTION_MAINNET: "_DAPPNODE_GLOBAL_STARKNET_EXECUTION_MAINNET", // "juno.dnp.dappnode.eth"
  STARKNET_EXECUTION_SEPOLIA: "_DAPPNODE_GLOBAL_STARKNET_EXECUTION_SEPOLIA", // "juno-sepolia.dnp.dappnode.eth"
};
