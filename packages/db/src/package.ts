import { PackageItemData, UpdateAvailable } from "@dappnode/types";
...
export const pkgItemMetadata = dbCache.indexedByKey<PackageItemData, string>({
  ...
  validate: (id, metadata) => typeof id === "string" && typeof metadata === "object"
});
 ...
 */
export const packageLatestKnownVersion = dbCache.indexedByKey<UpdateAvailable, string>({
 ...
 */
export const packageSentData = dbCache.indexedByKey<Record<string, string>, string>({
