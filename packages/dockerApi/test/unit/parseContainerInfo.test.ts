...
import { parseContainerInfo, parseDnpNameFromContainerName } from "../../src/index.js";
...
describe("modules / docker / parseContainerInfo", function () {
  it("should parse docker containers", async () => {
    ...
    const expectedContainers: PackageContainer[] = [
      ...
      {
        containerId: "951426e3fa2cbfd49a5198840764383af3961c2b29ba33a6b5f3dd45b953db9f",
      ...
      {
        containerId: "f789e9b7f00d7292c0db1f83b4dac063ce4a84d2bb3d55d12f9f492b7cbcbb2c",
      ...
      {
        containerId: "b7f32fcefcd4bfb34d0c293378993e4a40eb3e62d8a928c4f183065834a10fb2",
      ...
      {
        containerId: "c944a1549ba675b7229b55370cfd2f54dca1f86050fbef7df4ba453398f93c24",
      ...
      {
        containerId: "d01badf202548868538e0435163e66a12f5bbb253e82150ed951e89a4c13690d",
