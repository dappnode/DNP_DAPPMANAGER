...
import { fallbackToBoolean, booleanToFallback } from "components/EthMultiClient";
 ...
 */
export default function RepositoryFallback({ onBack, onNext }: { onBack?: () => void; onNext: () => void }) {
    ...
    <>
      <div className="header">
        ...
        <div className="description">
          DAppNode uses smart contracts to access a decentralized respository of DApps
          <br />
          Choose to use a remote node maintained by DAppNode Association if your node is not available (while syncing or
          failed)
        </div>
      </div>
