...
import { getEthClientTarget, getEthRemoteRpc } from "services/dappnodeStatus/selectors";
 ...
 */
export default function Repository({ onBack, onNext }: { onBack?: () => void; onNext: () => void }) {
    ...
    <>
      <div className="header">
        ...
        <div className="description">
          Official DAppNode Packages (DNPs) and Community Packages (Public) are published in a decentralized repository.
          To access this repository, DAppNode uses smart contracts on the Ethereum Blockchain.
          <br />
          You can either connect to a remote Ethereum node maintained by DAppNode or easily run your own node to promote
          decentralization.
        </div>
      </div>
