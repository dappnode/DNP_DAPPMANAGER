...
import { sdkPublishAppUrl, docsUrl } from "params";
...
export function SdkSection() {
  return (
    <div className="tw:space-y-4">
      ...
      <Card>
        <CardContent className="tw:flex tw:items-start tw:gap-3 tw:py-5">
          ...
          <div className="tw:flex tw:flex-col tw:gap-2 tw:space-y-1.5">
            ...
            <div className="tw:flex tw:flex-col tw:md:flex-row tw:gap-2 tw:justify-between">
      ...
      {/* SDK overview */}
      <Card>
        <CardContent className="tw:flex tw:items-center tw:justify-between tw:py-4">
