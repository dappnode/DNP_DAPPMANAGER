...
import { getCoreUpdateAvailable, getCoreRequestStatus } from "services/coreUpdate/selectors";
// Components
...
export default function SystemUpdate() {
  ...
  const coreProgressLogs = useSelector((state: any) => getProgressLogsOfDnp(state, coreDnpName));
