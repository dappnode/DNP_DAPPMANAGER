...
import { parseVolumeMappings, stringifyVolumeMappings, normalizeVolumePath } from "../../src/index.js";
...
describe("volumeMappings: parse, stringify and merge", () => {
  it("should parse and stringify volume mappings", () => {
    ...
    expect(parseVolumeMappings(volumeArray)).to.deep.equal(volumeMappings, "Wrong parse");

    expect(stringifyVolumeMappings(volumeMappings)).to.deep.equal(volumeArray, "Wrong stringify");
  });
