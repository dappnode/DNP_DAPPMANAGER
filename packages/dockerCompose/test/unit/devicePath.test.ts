...
import { getDevicePath, parseDevicePath, parseDevicePathMountpoint } from "../../src/index.js";
...
describe("device path", () => {
  ...
  it("Should parse a device path mountpoint", () => {
    expect(parseDevicePathMountpoint(devicePath)).to.equal(pathParts.mountpoint);
  });
});
