...
export const dockerApiResponseContainers: Docker.ContainerInfo[] = [
    {
        ...
        "Labels": {
            ...
            "dappnode.dnp.dependencies": "{\"nginx-proxy.dnp.dappnode.eth\":\"latest\",\"letsencrypt-nginx.dnp.dappnode.eth\":\"latest\"}",
    ...
    },
    {
        ...
        "ImageID": "sha256:c242241205d1c6eda03ce9d1bd01a3c3ef57313dd08245f704f698a850c0f44f",
        "Labels": {
            "com.docker.compose.config-hash": "10e1a8c31de331f37740c753a39cbc86883447afded4c1e68a535dbba86aa227",
            "com.docker.compose.container-number": "1",
            "com.docker.compose.oneoff": "False",
        ...
        "Mounts": [
            ...
            },
            {
                ...
                "Propagation": "",
                "RW": true,
                "Source": "/var/lib/docker/volumes/nginxproxydnpdappnodeeth_vhost.d/_data",
                "Type": "volume"
            },
            {
    ...
    {
        "Command": "/bin/sh -c 'vipnode host --rpc=http://my.ethchain.dnp.dappnode.eth:8545 -vv --payout=${PAYOUT_ADDRESS} --nodekey=/app/.ethchain/network/key'",
        "Created": 1560369616,
        "HostConfig": {
            "NetworkMode": "dncore_network"
        },
        ...
        "ImageID": "sha256:12c0721978f35ab4ca9dc3d13dee086c7c36dee954cb95fdfb49a58d52c2f8f5",
        "Labels": {
        ...
        "Mounts": [
            {
                ...
                "Propagation": "",
                "RW": false,
                "Source": "/var/lib/docker/volumes/dncore_ethchaindnpdappnodeeth_data/_data",
                "Type": "volume"
            }
        ],
        "Names": [
    ...
    },
    {
        ...
        "ImageID": "sha256:6ff4fc3d3200d3e56973b5eec60b0adfcd2ba890767e66d0295b7fd0c4e2d6f1",
        "Labels": {
        ...
        "Names": [
            "/DAppNodeCore-wifi.dnp.dappnode.eth"
        ],
        "NetworkSettings": {
            "Networks": {
                "dncore_network": {
    ...
    },
    {
        ...
        "ImageID": "sha256:d524055bf341ca0729920893feb7ff68c4f0308ddce2af7fa9e78b707f7a26c7",
        "Labels": {
            "com.docker.compose.config-hash": "c6c60533a7e09f813907dcdb20d026194bb81303798799c31308a63d7ce2b826",
            "com.docker.compose.container-number": "1",
            "com.docker.compose.oneoff": "False",
            "com.docker.compose.project": "dncore",
        ...
        "Names": [
            "/DAppNodeCore-admin.dnp.dappnode.eth"
        ],
        "NetworkSettings": {
            "Networks": {
                "dncore_network": {
    ...
    },
    {
        ...
        "Mounts": [
            ...
            },
            {
                ...
                "Propagation": "",
                "RW": true,
                "Source": "/var/lib/docker/volumes/dncore_dappmanagerdnpdappnodeeth_data/_data",
                "Type": "volume"
            },
            {
                "Destination": "/var/run/docker.sock",
    ...
    },
    {
        ...
        "ImageID": "sha256:af8539f3b3f2f5637afab068da01a3fdbe631ff812631ebeb70c713448b8dde0",
        "Labels": {
    ...
    {
        "Command": "/bin/sh -c 'parity --jsonrpc-port 8545 --jsonrpc-interface all --jsonrpc-hosts all --jsonrpc-cors all --ws-interface 0.0.0.0 --ws-port 8546 --ws-origins all --ws-hosts all --ws-max-connections 1000 --warp-barrier 7400000 $EXTRA_OPTS'",
        "Created": 1560334707,
        "HostConfig": {
            "NetworkMode": "dncore_network"
        },
        ...
        "ImageID": "sha256:646da4b970b2fb100012bced7abe4e8c442987edb2072f8e4f3bd298dded9950",
        "Labels": {
        ...
        "Names": [
            "/DAppNodeCore-ethchain.dnp.dappnode.eth"
        ],
        "NetworkSettings": {
            "Networks": {
                "dncore_network": {
    ...
    },
    {
        ...
        "ImageID": "sha256:163a33c60906e36833306c0c5fb4e742a84173c254cdf571d450370bbfd50751",
        "Labels": {
            "com.docker.compose.config-hash": "53e42eef9f08ede81dc7d3a05e64b9c64400250fc881962b0f9ebd0b485363a5",
            "com.docker.compose.container-number": "1",
            "com.docker.compose.oneoff": "False",
            "com.docker.compose.project": "dncore",
        ...
        "Mounts": [
            ...
            },
            {
                ...
                "Propagation": "",
                "RW": true,
                "Source": "/var/lib/docker/volumes/dncore_ipfsdnpdappnodeeth_export/_data",
                "Type": "volume"
            }
        ],
        "Names": [
    ...
    },
    {
        ...
        "Labels": {
            "com.docker.compose.config-hash": "4510ed11939156c0bf4e0784a3c661a866beb9dab0c699a0d65dbd7b5e9ce175",
            "com.docker.compose.container-number": "1",
            "com.docker.compose.oneoff": "False",
            "com.docker.compose.project": "dncore",
        ...
        "Mounts": [],
        "Names": [
            "/DAppNodeCore-ethforward.dnp.dappnode.eth"
        ],
        "NetworkSettings": {
            "Networks": {
                "dncore_network": {
    ...
    },
    {
        ...
        "Labels": {
            "com.docker.compose.config-hash": "5e698cef3803472edc1fcc3bba0fe16c24f3b65a8b97b57551f555a2a732b99f",
            "com.docker.compose.container-number": "1",
            "com.docker.compose.oneoff": "False",
        ...
        "Names": [
            "/DAppNodePackage-swarm.dnp.dappnode.eth"
        ],
        "NetworkSettings": {
            "Networks": {
                "dncore_network": {
    ...
    },
    {
        ...
        "Labels": {
            "com.docker.compose.config-hash": "ca8fea4d0f0081049a83a348ccf203dc04fd7301b79634e5eb1282b88a16753e",
            "com.docker.compose.container-number": "1",
            "com.docker.compose.oneoff": "False",
    ...
    },
    {
        ...
        "ImageID": "sha256:09835191918920701cea65129dd5e0f2d758341fd1a0fe3d6cb40ec7de1954fb",
        "Labels": {
            ...
            "com.docker.compose.version": "1.20.1",
            "dappnode.dnp.origin": "/ipfs/QmYfVW2LNHH8ZXa6KJmfFAz5zCQ8YHh2ZPt6aQmezJcbL7"
        },
        "Mounts": [
            {
                ...
                "Propagation": "",
                "RW": true,
                "Source": "/var/lib/docker/volumes/ipfsreplicatordnpdappnodeeth_pin-data/_data",
                "Type": "volume"
            }
        ],
        "Names": [
            "/DAppNodePackage-ipfs-replicator.dnp.dappnode.eth"
        ],
        "NetworkSettings": {
            "Networks": {
                "dncore_network": {
    ...
    {
        "Command": "/bin/sh -c 'geth --datadir /goerli --goerli --rpc --rpcaddr 0.0.0.0 --rpccorsdomain \"*\" --rpcvhosts \"*\" --ws --wsorigins \"*\" --wsaddr 0.0.0.0 $EXTRA_OPTS'",
        "Created": 1558258483,
        "HostConfig": {
            "NetworkMode": "dncore_network"
        },
        ...
        "Labels": {
            "com.docker.compose.config-hash": "acaf0f292fa641ac114e9a62dd9581b167379a433cad7f0f796ae1e8c427aab2",
            "com.docker.compose.container-number": "1",
            "com.docker.compose.oneoff": "False",
            ...
            "com.docker.compose.version": "1.20.1",
            "dappnode.dnp.chain": "ethereum",
            "portsToClose": "[{\"number\":32769,\"type\":\"TCP\"},{\"number\":32771,\"type\":\"UDP\"},{\"number\":32770,\"type\":\"UDP\"}]"
        },
        "Mounts": [
            {
                "Destination": "/goerli",
        ...
        "Names": [
            "/DAppNodePackage-goerli-geth.dnp.dappnode.eth"
        ],
        "NetworkSettings": {
            "Networks": {
                "dncore_network": {
    ...
    },
    {
        ...
        "Labels": {
            "com.docker.compose.config-hash": "7886a2bf0a84e2766732c8506bed5817890f583d8f26908dd5c1c01300fac623",
            "com.docker.compose.container-number": "1",
            "com.docker.compose.oneoff": "False",
            "com.docker.compose.project": "dncore",
        ...
        "Mounts": [],
        "Names": [
            "/DAppNodeCore-wamp.dnp.dappnode.eth"
        ],
        "NetworkSettings": {
            "Networks": {
                "dncore_network": {
    ...
    },
    {
        ...
        "Created": 1554919920,
        "HostConfig": {
            "NetworkMode": "dappnode-watchgit_default"
        },
        "Id": "75d2554cec04709dae16d67bf2ad7d2607794234f58f6506063c6d8ec7d929a6",
        "Image": "dappnode-watchgit:0.1.0",
        "ImageID": "sha256:c5769fc7c0e45dab0aaadea3b23d7b73e515704be8f4576afff6154d9d1b419c",
        "Labels": {
            "com.docker.compose.config-hash": "3097f13a5f1220b01424abf56f8d14c35ab37f108fef56e8603071c2b94ea50d",
            "com.docker.compose.container-number": "1",
            "com.docker.compose.oneoff": "False",
            "com.docker.compose.project": "dappnode-watchgit",
            "com.docker.compose.service": "dappnode-watchgit.eth",
            "com.docker.compose.version": "1.22.0"
        },
        "Mounts": [
            {
        ...
        "NetworkSettings": {
            "Networks": {
                "dappnode-watchgit_default": {
                    ...
                    "NetworkID": "41d4d2898cb88568d1d6ddd2facddf05983aa4a44c97b34fb07f421540ee213b"
                }
            }
        },
        "Ports": [],
