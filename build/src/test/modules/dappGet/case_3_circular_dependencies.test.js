...
function getRepo() {
    ...
    return {
      'C1-A': {
        '1.0.0': {dependencies: {'C1-A': '1.0.0'}},
      },
      'C2-A': {
        '1.0.0': {dependencies: {'C2-B': '1.0.0'}},
      },
      'C2-B': {
        '1.0.0': {dependencies: {'C2-A': '1.0.0'}},
      },
      'C3-A': {
        '1.0.0': {dependencies: {'C3-B': '1.0.0'}},
      },
      'C3-B': {
        '1.0.0': {dependencies: {'C3-C': '1.0.0'}},
      },
      'C3-C': {
        '1.0.0': {dependencies: {'C3-A': '1.0.0'}},
      },
    };
  }
